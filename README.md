...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-uobgvzu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-uobgvzu.containers.anotherwebservice.com/
...
```
git clone git@github.com:x35gaming/container-uobgvzu.git
cd container-uobgvzu
```
...
```
docker attach container-uobgvzu
```
